...
export default defineComponent({
  ...
  methods: {
    hasSubspecies(specie: SpecieItem): boolean {
      return 'string' !== typeof (specie.value);
    },

    getSubspecies(specie: SpecieItem): SpecieItems {
      return specie.value as SpecieItems;
    },

    anySubspecieChecked(specie: SpecieItem): boolean {
  ...
  >
    ...
    >
      <span class="btn btn-outline-secondary">
        ...
        <span
          v-if="anySubspecieChecked(specie)"
          class="descendants-indicator"
        >
