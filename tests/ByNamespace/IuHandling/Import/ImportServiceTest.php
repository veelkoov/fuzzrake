...
namespace App\Tests\ByNamespace\IuHandling\Import;
...
class ImportServiceTest extends FuzzrakeTestCase
{
    ...
    public function testAddedDateIsHandledProperly(): void
    {
        ...
        $subject = $this->getImportServiceForGetImportDataFor([[['TEST001'], []]]);
    ...
    public function testUpdatedDateIsHandledProperly(): void
    {
        ...
        $subject = $this->getImportServiceForGetImportDataFor([[['TEST001'], [$creator]]]);
        $result = $subject->getImportDataFor($submission);
    ...
    public function testResolvingMultipleMatchedByCreatorIdInLegacySubmissions(): void
    {
        ...
        $subject = $this->getImportServiceForGetImportDataFor([
    ...
    public function testUpdateHandlesCreatorIdChangeProperly(): void
    {
        ...
        $result1 = $this->getImportServiceForGetImportDataFor([[['TEST003'], [$creator]]])->getImportDataFor($submission1);
        ...
        $result2 = $this->getImportServiceForGetImportDataFor([[['TEST001'], [$creator]]])->getImportDataFor($submission2);
     ...
     */
    private function getImportServiceForGetImportDataFor(array $calls): ImportService
    {
