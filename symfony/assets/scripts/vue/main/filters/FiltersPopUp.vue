    ...
    <div class="modal-dialog modal-xl">
      <div id="filters-top" class="modal-content">
        <div class="modal-header">
          <h5 id="filtersTitle" class="modal-title">Filters</h5>
          <span>
            <button
              type="button"
...
export default class FiltersPopUp extends Vue {
    ...
    this.filters.push(
      ...[
        new Filter(
          ...
          "CountriesFilter",
          "CountriesHelp",
          Static.getFiltersOptions().countries,
        ),
        new Filter(
          "states",
          "States",
          "MultiselectFilter",
          "StatesHelp",
          Static.getFiltersOptions().states,
        ),
        new Filter(
          "languages",
          "Languages",
          "MultiselectFilter",
          "LanguagesHelp",
          Static.getFiltersOptions().languages,
        ),
        new Filter(
          "styles",
          "Styles",
          "MultiselectFilter",
          "StylesHelp",
          Static.getFiltersOptions().styles,
        ),
        new Filter(
          "features",
          "Features",
          "MultiselectFilter",
          "FeaturesHelp",
          Static.getFiltersOptions().features,
          true,
        ),
        new Filter(
          "orderTypes",
          ...
          "MultiselectFilter",
          "OrderTypesHelp",
          Static.getFiltersOptions().orderTypes,
        ),
        new Filter(
          "productionModels",
          "Production models",
          "MultiselectFilter",
          "ProductionModelsHelp",
          Static.getFiltersOptions().productionModels,
        ),
        new Filter(
          "openFor",
          "Open for",
          "MultiselectFilter",
          "OpenForHelp",
          Static.getFiltersOptions().openFor,
        ),
        new Filter(
          "species",
          "Species",
          "SpeciesFilter",
          "SpeciesHelp",
          Static.getFiltersOptions().species,
        ),
        new Filter(
          "paymentPlans",
          "Payment plans",
          "MultiselectFilter",
          "PaymentPlansHelp",
          Static.getFiltersOptions().paymentPlans,
        ),
        new Filter(
          "inactive",
          "Hidden",
          "MultiselectFilter",
          "InactiveHelp",
          Static.getFiltersOptions().inactive,
        ),
      ],
    );
  ...
  public mounted(): void {
    (this.$refs["modal"] as HTMLElement).addEventListener(
      "hidden.bs.modal",
      () => this.onModalClosed(),
    );
  ...
  private getActiveFiltersCount(): number {
    return this.filters
      .map((filter) => (filter.state.isActive ? 1 : 0))
