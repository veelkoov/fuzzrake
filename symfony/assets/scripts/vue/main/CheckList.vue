<template>
  <div class="card bg-light mb-3">
    <div class="card-body">
      ...
      <p class="card-text">
        This tool serves for finding a maker/<wbr />studio which will best match
        your expectations. It can save you some time searching. What it can't do
        for you - <strong>which means you must do that yourself</strong> - is to
        verify the legitimacy of the maker/<wbr />studio you want to commission.
      </p>

      <p class="card-text">
        The <a :href="Static.getShouldKnowPath()">What you should know</a> page
        contains some helpful information, tips, and links to external
        resources. It includes a <em>Learn about <strong>the risk</strong></em>
        <!-- grep-learn-about-the-risk -->
        section.
        <br />

        <span class="small">
          <strong class="text-danger"
            >You will most probably not get your fursuit in the next weeks, so
            reading a bit will not hurt.</strong
          >
          Slow down.
        </span>
      </p>
      ...
      <div class="card-text">
        <div class="form-check">
          <input
            id="checklist-ill-be-careful"
            v-model="illBeCareful"
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="aasImNotAdult">
                ...
                <small class="text-muted"
                  >I am looking for a maker who accepts commissions from
                  underage people.</small
                >
              </label>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-check">
              ...
              <label class="form-check-label" for="aasImAdult">
                ...
                <small class="text-muted"
                  >Yes, lying about my age would be a stupid idea and could get
                  me banned from commissioning my beloved fursuit maker,
                  ever.</small
                >
              </label>
            </div>
          ...
          <div class="col-md-6">
            <div class="form-check">
              ...
              <label class="form-check-label" for="aasKeepSfw">
                I prefer makers with "family-friendly" websites and social
                media.
              </label>
            </div>
          </div>
...
export default class CheckList extends Vue {
  ...
  private get buttonDisabled(): boolean {
    return (
      !this.illBeCareful ||
      null === this.isAdult ||
      (this.isAdult && null === this.wantsSfw)
    );
  }
