    ...
    public function testSuccessfulResolve(): void
    {
        $subject = new ScritchMiniatureUrlResolver(self::getHttpClientMock(
            new ExpectedHttpCall(
                ...
                'https://scritch.es/',
                responseCode: 200,
                responseHeaders: new StringStringMap(['Set-Cookie' => 'csrf-token=%21%40%23%24%25%5E%26*%28%29; path=/; SameSite=Strict']),
            ),
            new ExpectedHttpCall(
                'POST',
                ...
                new StringStringMap(['authorization' => 'Scritcher !@#$%^&*()', 'X-CSRF-Token' => '!@#$%^&*()']),
                200,
